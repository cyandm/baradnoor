		...
		<div class="swiper" id="swiperAboutUs">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img src="<?php echo get_stylesheet_directory_uri() . '/assets/imgs/background-about-us-1.svg' ?>"
						alt="background-slider">
				</div>
				<div class="swiper-slide">
					<img src="<?php echo get_stylesheet_directory_uri() . '/assets/imgs/background-about-us-2.svg' ?>"
						alt="background-slider">
				</div>
				...
				<div class="container-images-section-two">
					<?php if ( $image_section_two ) : ?>
						<div class="container-images-name-job">
							...
							<div class="container-name-job-title">
								<?php if ( $name_person_one != null )
									echo "<div> $name_person_one </div>"; ?>
								<?php if ( $job_title_person_one != null )
									echo "<div> $job_title_person_one </div>"; ?>
					...
					<?php if ( $image_two_section_two ) : ?>
						...
						<div class="container-images-name-job">
							...
							<div class="container-name-job-title">
								<?php if ( $name_person_two != null )
									echo "<div> $name_person_two </div>"; ?>
								<?php if ( $job_title_person_two != null )
									echo "<div> $job_title_person_two </div>"; ?>
					...
					<?php if ( $image_three_section_two ) : ?>
						<div class="container-images-name-job">
							...
							<div class="container-name-job-title">
								<?php if ( $name_person_three != null )
									echo "<div> $name_person_three </div>"; ?>
								<?php if ( $job_title_person_three != null )
									echo "<div> $job_title_person_three </div>"; ?>
					...
					<?php if ( $image_four_section_two ) : ?>
						<div class="container-images-name-job">
							...
							<div class="container-name-job-title">
								<?php if ( $name_person_two != null )
									echo "<div> $name_person_two </div>"; ?>
								<?php if ( $job_title_person_four != null )
									echo "<div> $job_title_person_four </div>"; ?>
